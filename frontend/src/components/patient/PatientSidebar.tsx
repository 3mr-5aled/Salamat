    ...
    <>
      ...
      <aside className="w-64 bg-white border-r border-[#E2E8F0] flex flex-col hidden md:flex shrink-0">
        ...
        <div className="px-3 pb-4 relative" ref={popoverRef}>
          {/* Sign-out popover */}
          {profileOpen && (
            <div className="absolute bottom-full left-3 right-3 mb-2 bg-white rounded-2xl border border-[#E2E8F0] shadow-[0_8px_32px_rgba(0,0,0,0.08)] overflow-hidden z-50">
              {/* User info header */}
              <div className="px-4 py-3.5 border-b border-[#E2E8F0]">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#16A34A] to-[#15803D] flex items-center justify-center text-white text-xs font-black shrink-0">
                    {initials}
                  </div>
          ...
          >
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#16A34A] to-[#15803D] flex items-center justify-center text-white text-xs font-black shrink-0">
              {initials}
            </div>
            <div className="flex-1 min-w-0 text-left">
              <div className="text-sm font-bold text-[#0F172A] truncate">{user?.fullName || user?.name}</div>
              <div className="text-[10px] font-semibold text-[#64748B] uppercase tracking-wider">Patient</div>
            </div>
            <ChevronUp
              size={16}
